<%@ Page Title="" Language="C#" MasterPageFile="~/Nav.Master" AutoEventWireup="true" CodeBehind="CreateNewQuestion.aspx.cs" Inherits="SAF_Website.CreateNewQuestion" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col-sm-8">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <asp:Button ID="ButtonAdd" CssClass="btn-primary form-control" runat="server" Text="Add Questions" OnClick="ButtonAdd_Click"></asp:Button>
                                    </div>
                                    <div class="col-sm-4">
                                        <asp:Button ID="ButtonPreview"  CssClass="btn-dark form-control" runat="server" Visible ="false" Text="Preview" OnClick="ButtonPreview_Click"></asp:Button>
                                    </div>
