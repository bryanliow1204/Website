<%@ Page Title="" Language="C#" MasterPageFile="~/Nav.Master" AutoEventWireup="true" CodeBehind="PreviewChecklists.aspx.cs" Inherits="SAF_Website.PreviewChecklists" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="container" runat="server">
       ...
       <div class="container">
           <br />
           <!--Title Section-->
           <h4 style="color: white; font-family:Raleway;">View Checklist Questions</h4>
           ...
           <div class="row">
               ...
               <div class="col-md-10">
                   <div class="row" style="margin-bottom: 20px;">
                       ...
                       <div class="col-md-8">
                           <asp:TextBox ID="TextBoxChecklist" runat="server" CssClass="form-control" placeholder="Enter name of question you wish to search" OnTextChanged="TextBoxChecklist_TextChanged"></asp:TextBox>
                       </div>
                   </div>
                   <!-- Checklist Section: -->
                   <div class="row">
    ...
    <div>
        <div class="container">
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover align-content-center table-responsive-sm mt-4 " GridLines="None" Border-Style="none" Style="font-size: 15px;overflow:hidden;word-wrap:break-word;table-layout: fixed;" AllowPaging="True" AllowSorting="True" PageSize="5" OnSorting="GridView1_Sorting" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowDeleting="GridView1_RowDeleting" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"  OnRowUpdating="GridView1_RowUpdating" AutoGenerateColumns="False" BackColor="White">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    ...
                                    <div runat="server" class="dropdown-menu" id="dropdowncontents">
                                        <asp:LinkButton ID="LinkEdit" CommandName="Update" CssClass="dropdown-item" runat="server">Update</asp:LinkButton>
