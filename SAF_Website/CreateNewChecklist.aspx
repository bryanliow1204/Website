<%@ Page Title="" Language="C#" MasterPageFile="~/Nav.Master" AutoEventWireup="true" CodeBehind="CreateNewChecklist.aspx.cs" Inherits="SAF_Website.CreateNewChecklist" %>
<%@ MasterType VirtualPath="~/Nav.Master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="Contents/Css/Checklist.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="container" runat="server">
    ...
    <div style="background: rgb(0,93,129); background: linear-gradient(-160deg, rgba(0,93,129,1) 0%, rgba(0,93,129,1) 29%, rgba(0,142,168,1) 100%);">
        <div class="container">
            <br />
            <h4 style="color: white; margin-bottom: 10px; font-family: Raleway;">Create New Checklist</h4>
            ...
            <div class="alert alert-info alert-dismissible fade show" role="alert" runat="server" id="theRadioButtons" visible="false" auto-close="3000">
                <asp:Label ID="LabelMsgRadioButtons" runat="server" Text=""></asp:Label>
            </div>
                ...
                <div class="col-md-4">
                    <div class ="row">
                        <div class="col-md-6">
                            ...
                            <asp:LinkButton ID="LinkButtonEdit" runat="server" CssClass="btn btn-warning form-control" Visible="false" OnClick="LinkButtonEdit_Click"><i class="far fa-edit"></i>&nbsp&nbspEdit</asp:LinkButton>
    ...
    <!-- Table Section: -->
    <div>
        <div class="container text-center" runat="server" id="table_section" visible="false">
            <div class="alert alert-success alert-dismissible fade show mt-2" role="alert" runat="server" id="Successlabel" auto-close="3000" visible="false">
                <asp:Label ID="LabelSuccess" runat="server" Text="Successfully added" ForeColor="Green"></asp:Label>
            </div>
                          ...
                          <div class="col-sm-8">
                              ...
                              <!--content for first option textbox: -->
                                  ...
                                  <div class="col-sm-1 mt-2">
                                       <asp:RadioButton ID="RadioButtonOption1" runat="server" OnCheckedChanged="RadioButtonOption1_CheckedChanged1"  AutoPostBack="True" GroupName = "radiobutton"></asp:RadioButton>
                                  </div>
                                   <div class="col-sm-1"style="font-size:25px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col-sm-8">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <asp:Button ID="ButtonAdd" CssClass="btn-primary form-control" runat="server" Text="Add Questions" OnClick="ButtonAdd_Click" Visible="false"></asp:Button>
                                    </div>
                                    <div class="col-sm-4">
                                        <asp:Button ID="ButtonPreview"  CssClass="btn-dark form-control" runat="server" Text="Preview" OnClick="ButtonPreview_Click" Visible="false"></asp:Button>
                                    </div>
